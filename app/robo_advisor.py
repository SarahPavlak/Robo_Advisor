...
while True:
        user_input = input ("Please input a singular stock identifier, or 'EXIT' if you do not wish to continue: ")
        if user_input == "EXIT":
                print("The program will now close gracefully, thank you!")
                exit()
                ...
                buy_sell_calc = user_input

                print("-----------------")
                print(f"STOCK SYMBOL: {symbol}")
                print("RUN AT:" + datetime.datetime.now().strftime("%Y-%m-%d %H:%m:%S")) #fix date time 
                print("-----------------")
